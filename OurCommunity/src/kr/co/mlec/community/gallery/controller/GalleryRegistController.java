...
@WebServlet("/gallery/regist")
public class GalleryRegistController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String savePath = "C:\\java73\\web-workspace\\OurCommunity\\WebContent\\PothoGallery\\" + yStr + "/" + mStr + "/" + dStr;

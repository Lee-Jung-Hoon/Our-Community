...
@WebServlet("/studyFile/regist")
public class StudyFileRegisterController extends HttpServlet{
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		String savePath = "C:\\Java73\\web-WorkSpace\\OurCommunity\\WebContent\\studyFile" + yStr + "/" + mStr + "/" + dStr;
		savePath = req.getServletContext().getRealPath("/") + "studyFile\\" + yStr + "/" + mStr + "/" + dStr;
		String readPath = "C:\\Java73\\tomcat-work\\wtpwebapps\\OurCommunity\\studyFile\\" + yStr + "/" + mStr + "/" + dStr;
		...
		MultipartRequest multi = new MultipartRequest(req, savePath, limitCapacity, encType,

...
<body>
   ...
   <hr />
   <br />
   <form action="/OurCommunity/bitcampboard/NoticeBitcampModifyUpdateBoardController" method="post">
      <table style="height: 500;" align="center">
         ...
         <tr>
            <th>제목</th>
            <td colspan="3"><input type="text" size="148" name="title" value="${board.title}"/></td>
         </tr>

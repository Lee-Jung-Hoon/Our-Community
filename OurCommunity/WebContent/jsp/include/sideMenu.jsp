   ...
   <div class="sideBar" align="center">
         ...
         <li><a href="#">▥ Notice</a>
            <ul class="ul2">
               ...
               <c:if test="${grade eq '운영자'}">
                  <li><a href="/OurCommunity/adminboard/NoticeAdminListBoardController">▷ 관리자게시판</a></li>
               </c:if>
            </ul></li>
      </ul>
      <ul class="ul3">
      ...
      <ul class="ul5">
		...
		<c:choose>
			...
			<c:otherwise>
				<ul class="ul7">
					<li><a href="/OurCommunity/jsp/mypage/myPage.jsp">▥ MyPage</a>
						<ul class="ul8">
							<c:if test="${grade eq '운영자'}">
								<li><a href="/OurCommunity/memberInfo/list">□ 회원정보관리</a></li>
							</c:if>
						</ul></li>
				</ul>
			</c:otherwise>
